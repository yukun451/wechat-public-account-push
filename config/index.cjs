...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      useTemplateId: '	7LFP-not_JNInZ2RtRoW491QMfawZaub-qSSiJAjZ_g',
      // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
      horoscopeDate: '11-23',
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '梅梅', year: '1996', date: '10-13',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '梅梅', year: '1996', date: '11-23',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: 'V24o9OwIbdykI2PXTK9kWHoqI9z7O4mpZduEi-nP8rk',
